...
contract ReputationEngine is Ownable {
    ...
    mapping(address => uint256) public attestationScores;
    mapping(address => address) public attestationOracles; 
    ...
    function _getPaymentScore(address borrower) internal view returns (uint256) {
        uint256 repaymentRate = soulboundToken.getRepaymentRate(borrower);
